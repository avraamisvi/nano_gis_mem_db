...
pub fn parse_statement(statement: &Statement) -> Box<dyn QueryExecutor> {    
    match statement {
        ...
        // Statement::Insert { or, ignore, into, table_name, columns, overwrite, source, partitioned, after_columns, table, on, returning } => todo!(),
